...
import hero_bg_img from "../assets/img/Home/hero_bg_img.jpg";
    ...
    return (
        <section className='relative w-full h-screen flex items-center justify-center overflow-hidden'>
            ...
            <div className='hero-content relative z-10 flex flex-col items-center text-center text-white px-4 sm:px-6 lg:px-8'>
                ...
                {/* CTA Button */}
                <button className='hero-button bg-white text-black hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center'>
